...
<security:authorize access="isAnonymous()">
	<form:form modelAttribute="registerCompanyFormObject"
		action="company/company/register.do">
		...
		<fieldset>
			...
			<div>
				<p>
					<form:errors path="commercialName" cssClass="error" />
				</p>
				<strong><form:label path="commercialName">
