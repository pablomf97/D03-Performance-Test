...
public class MiscellaneousDataController extends AbstractController{
	...
	public ModelAndView save(@Valid MiscellaneousData data,int curriculaId, final BindingResult binding){
		ModelAndView result;
	...
	public ModelAndView delete(@Valid MiscellaneousData data,final BindingResult binding){
		ModelAndView result;
		...
		if(binding.hasErrors()){
			...
			try{
				Curricula currentCurricula = this.curriculaService.getCurriculaByMiscellaneousData(data.getId());
	...
	protected ModelAndView createEditModelAndView(final MiscellaneousData data,int curriculaId) {
		ModelAndView result;
	...
	protected ModelAndView createEditModelAndView(final MiscellaneousData data, Integer curriculaId,final String messageError) {
		ModelAndView result;
		Curricula currentCurricula;
